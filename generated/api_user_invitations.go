...
func (r ApiUserInvitationsVisibleAppsGetToManyRelatedRequest) Execute() (*AppsResponse, *http.Response, error) {
...
//
//	@return AppsResponse
func (a *UserInvitationsApiService) UserInvitationsVisibleAppsGetToManyRelatedExecute(r ApiUserInvitationsVisibleAppsGetToManyRelatedRequest) (*AppsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
