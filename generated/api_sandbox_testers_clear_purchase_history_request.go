...
type ApiSandboxTestersClearPurchaseHistoryRequestCreateInstanceRequest struct {
	ctx                                                      context.Context
...
func (r ApiSandboxTestersClearPurchaseHistoryRequestCreateInstanceRequest) SandboxTestersClearPurchaseHistoryRequestV2CreateRequest(sandboxTestersClearPurchaseHistoryRequestV2CreateRequest SandboxTestersClearPurchaseHistoryRequestV2CreateRequest) ApiSandboxTestersClearPurchaseHistoryRequestCreateInstanceRequest {
	r.sandboxTestersClearPurchaseHistoryRequestV2CreateRequest = &sandboxTestersClearPurchaseHistoryRequestV2CreateRequest
	return r
}

func (r ApiSandboxTestersClearPurchaseHistoryRequestCreateInstanceRequest) Execute() (*SandboxTestersClearPurchaseHistoryRequestV2Response, *http.Response, error) {
...
SandboxTestersClearPurchaseHistoryRequestCreateInstance Method for SandboxTestersClearPurchaseHistoryRequestCreateInstance
	...
	@return ApiSandboxTestersClearPurchaseHistoryRequestCreateInstanceRequest
*/
func (a *SandboxTestersClearPurchaseHistoryRequestApiService) SandboxTestersClearPurchaseHistoryRequestCreateInstance(ctx context.Context) ApiSandboxTestersClearPurchaseHistoryRequestCreateInstanceRequest {
	return ApiSandboxTestersClearPurchaseHistoryRequestCreateInstanceRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SandboxTestersClearPurchaseHistoryRequestApiService) SandboxTestersClearPurchaseHistoryRequestCreateInstanceExecute(r ApiSandboxTestersClearPurchaseHistoryRequestCreateInstanceRequest) (*SandboxTestersClearPurchaseHistoryRequestV2Response, *http.Response, error) {
	var (
