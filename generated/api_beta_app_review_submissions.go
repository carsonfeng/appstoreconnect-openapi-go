...
func (r ApiBetaAppReviewSubmissionsBuildGetToOneRelatedRequest) Execute() (*BuildResponse, *http.Response, error) {
...
func (a *BetaAppReviewSubmissionsApiService) BetaAppReviewSubmissionsBuildGetToOneRelatedExecute(r ApiBetaAppReviewSubmissionsBuildGetToOneRelatedRequest) (*BuildResponse, *http.Response, error) {
	var (
