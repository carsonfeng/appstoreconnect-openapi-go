...
type ApiAppPricePointsEqualizationsGetToManyRelatedRequest struct {
	ctx                  context.Context
...
func (r ApiAppPricePointsEqualizationsGetToManyRelatedRequest) FilterTerritory(filterTerritory []string) ApiAppPricePointsEqualizationsGetToManyRelatedRequest {
	r.filterTerritory = &filterTerritory
	return r
}

// the fields to include for returned resources of type appPricePoints
func (r ApiAppPricePointsEqualizationsGetToManyRelatedRequest) FieldsAppPricePoints(fieldsAppPricePoints []string) ApiAppPricePointsEqualizationsGetToManyRelatedRequest {
	r.fieldsAppPricePoints = &fieldsAppPricePoints
	return r
}

// the fields to include for returned resources of type apps
func (r ApiAppPricePointsEqualizationsGetToManyRelatedRequest) FieldsApps(fieldsApps []string) ApiAppPricePointsEqualizationsGetToManyRelatedRequest {
	r.fieldsApps = &fieldsApps
	return r
}

// the fields to include for returned resources of type territories
func (r ApiAppPricePointsEqualizationsGetToManyRelatedRequest) FieldsTerritories(fieldsTerritories []string) ApiAppPricePointsEqualizationsGetToManyRelatedRequest {
	r.fieldsTerritories = &fieldsTerritories
	return r
}

// maximum resources per page
func (r ApiAppPricePointsEqualizationsGetToManyRelatedRequest) Limit(limit int32) ApiAppPricePointsEqualizationsGetToManyRelatedRequest {
	r.limit = &limit
	return r
}

// comma-separated list of relationships to include
func (r ApiAppPricePointsEqualizationsGetToManyRelatedRequest) Include(include []string) ApiAppPricePointsEqualizationsGetToManyRelatedRequest {
	r.include = &include
	return r
}

func (r ApiAppPricePointsEqualizationsGetToManyRelatedRequest) Execute() (*AppPricePointsV3Response, *http.Response, error) {
...
AppPricePointsEqualizationsGetToManyRelated Method for AppPricePointsEqualizationsGetToManyRelated
	...
	@return ApiAppPricePointsEqualizationsGetToManyRelatedRequest
*/
func (a *AppPricePointsApiService) AppPricePointsEqualizationsGetToManyRelated(ctx context.Context, id string) ApiAppPricePointsEqualizationsGetToManyRelatedRequest {
	return ApiAppPricePointsEqualizationsGetToManyRelatedRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *AppPricePointsApiService) AppPricePointsEqualizationsGetToManyRelatedExecute(r ApiAppPricePointsEqualizationsGetToManyRelatedRequest) (*AppPricePointsV3Response, *http.Response, error) {
	var (
...
func (r ApiAppPricePointsGetInstanceRequest) Execute() (*AppPricePointV3Response, *http.Response, error) {
...
func (a *AppPricePointsApiService) AppPricePointsGetInstanceExecute(r ApiAppPricePointsGetInstanceRequest) (*AppPricePointV3Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiAppPricePointsGetInstance_0Request struct {
	ctx                  context.Context
	ApiService           *AppPricePointsApiService
	id                   string
	fieldsAppPricePoints *[]string
...
// the fields to include for returned resources of type appPricePoints
func (r ApiAppPricePointsGetInstance_0Request) FieldsAppPricePoints(fieldsAppPricePoints []string) ApiAppPricePointsGetInstance_0Request {
	r.fieldsAppPricePoints = &fieldsAppPricePoints
	return r
}

// comma-separated list of relationships to include
func (r ApiAppPricePointsGetInstance_0Request) Include(include []string) ApiAppPricePointsGetInstance_0Request {
	r.include = &include
	return r
}

// the fields to include for returned resources of type territories
func (r ApiAppPricePointsGetInstance_0Request) FieldsTerritories(fieldsTerritories []string) ApiAppPricePointsGetInstance_0Request {
	r.fieldsTerritories = &fieldsTerritories
	return r
}

func (r ApiAppPricePointsGetInstance_0Request) Execute() (*AppPricePointResponse, *http.Response, error) {
...
AppPricePointsGetInstance_0 Method for AppPricePointsGetInstance_0
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id the id of the requested resource
	@return ApiAppPricePointsGetInstance_0Request

Deprecated
*/
func (a *AppPricePointsApiService) AppPricePointsGetInstance_1(ctx context.Context, id string) ApiAppPricePointsGetInstance_0Request {
	return ApiAppPricePointsGetInstance_0Request{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
// Deprecated
func (a *AppPricePointsApiService) AppPricePointsGetInstance_1Execute(r ApiAppPricePointsGetInstance_0Request) (*AppPricePointResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
