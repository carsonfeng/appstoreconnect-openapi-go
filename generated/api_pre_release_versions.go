...
func (r ApiPreReleaseVersionsAppGetToOneRelatedRequest) Execute() (*AppResponse, *http.Response, error) {
...
//
//	@return AppResponse
func (a *PreReleaseVersionsApiService) PreReleaseVersionsAppGetToOneRelatedExecute(r ApiPreReleaseVersionsAppGetToOneRelatedRequest) (*AppResponse, *http.Response, error) {
	var (
...
func (r ApiPreReleaseVersionsBuildsGetToManyRelatedRequest) Execute() (*BuildsResponse, *http.Response, error) {
...
func (a *PreReleaseVersionsApiService) PreReleaseVersionsBuildsGetToManyRelatedExecute(r ApiPreReleaseVersionsBuildsGetToManyRelatedRequest) (*BuildsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
