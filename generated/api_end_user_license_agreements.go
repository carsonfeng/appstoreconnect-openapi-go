...
func (r ApiEndUserLicenseAgreementsTerritoriesGetToManyRelatedRequest) Execute() (*TerritoriesResponse, *http.Response, error) {
...
func (a *EndUserLicenseAgreementsApiService) EndUserLicenseAgreementsTerritoriesGetToManyRelatedExecute(r ApiEndUserLicenseAgreementsTerritoriesGetToManyRelatedRequest) (*TerritoriesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
