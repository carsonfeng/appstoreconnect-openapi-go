...
func (r ApiProfilesBundleIdGetToOneRelatedRequest) Execute() (*BundleIdResponse, *http.Response, error) {
...
func (a *ProfilesApiService) ProfilesBundleIdGetToOneRelatedExecute(r ApiProfilesBundleIdGetToOneRelatedRequest) (*BundleIdResponse, *http.Response, error) {
	var (
...
func (r ApiProfilesCertificatesGetToManyRelatedRequest) Execute() (*CertificatesResponse, *http.Response, error) {
...
func (a *ProfilesApiService) ProfilesCertificatesGetToManyRelatedExecute(r ApiProfilesCertificatesGetToManyRelatedRequest) (*CertificatesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiProfilesDevicesGetToManyRelatedRequest) Execute() (*DevicesResponse, *http.Response, error) {
...
func (a *ProfilesApiService) ProfilesDevicesGetToManyRelatedExecute(r ApiProfilesDevicesGetToManyRelatedRequest) (*DevicesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
