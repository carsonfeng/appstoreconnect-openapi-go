...
func (r ApiBetaGroupsAppGetToOneRelatedRequest) Execute() (*AppResponse, *http.Response, error) {
...
//
//	@return AppResponse
func (a *BetaGroupsApiService) BetaGroupsAppGetToOneRelatedExecute(r ApiBetaGroupsAppGetToOneRelatedRequest) (*AppResponse, *http.Response, error) {
	var (
...
func (r ApiBetaGroupsBetaTestersGetToManyRelatedRequest) Execute() (*BetaTestersResponse, *http.Response, error) {
...
func (a *BetaGroupsApiService) BetaGroupsBetaTestersGetToManyRelatedExecute(r ApiBetaGroupsBetaTestersGetToManyRelatedRequest) (*BetaTestersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiBetaGroupsBuildsGetToManyRelatedRequest) Execute() (*BuildsResponse, *http.Response, error) {
...
func (a *BetaGroupsApiService) BetaGroupsBuildsGetToManyRelatedExecute(r ApiBetaGroupsBuildsGetToManyRelatedRequest) (*BuildsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
