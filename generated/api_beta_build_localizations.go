...
func (r ApiBetaBuildLocalizationsBuildGetToOneRelatedRequest) Execute() (*BuildResponse, *http.Response, error) {
...
func (a *BetaBuildLocalizationsApiService) BetaBuildLocalizationsBuildGetToOneRelatedExecute(r ApiBetaBuildLocalizationsBuildGetToOneRelatedRequest) (*BuildResponse, *http.Response, error) {
	var (
