...
func (r ApiUsersVisibleAppsGetToManyRelatedRequest) Execute() (*AppsResponse, *http.Response, error) {
...
//
//	@return AppsResponse
func (a *UsersApiService) UsersVisibleAppsGetToManyRelatedExecute(r ApiUsersVisibleAppsGetToManyRelatedRequest) (*AppsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
