...
func (r ApiBetaAppLocalizationsAppGetToOneRelatedRequest) Execute() (*AppResponse, *http.Response, error) {
...
//
//	@return AppResponse
func (a *BetaAppLocalizationsApiService) BetaAppLocalizationsAppGetToOneRelatedExecute(r ApiBetaAppLocalizationsAppGetToOneRelatedRequest) (*AppResponse, *http.Response, error) {
	var (
