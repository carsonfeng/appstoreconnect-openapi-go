...
func (r ApiBuildBetaDetailsBuildGetToOneRelatedRequest) Execute() (*BuildResponse, *http.Response, error) {
...
func (a *BuildBetaDetailsApiService) BuildBetaDetailsBuildGetToOneRelatedExecute(r ApiBuildBetaDetailsBuildGetToOneRelatedRequest) (*BuildResponse, *http.Response, error) {
	var (
