...
func (r ApiBundleIdsAppGetToOneRelatedRequest) Execute() (*AppResponse, *http.Response, error) {
...
//
//	@return AppResponse
func (a *BundleIdsApiService) BundleIdsAppGetToOneRelatedExecute(r ApiBundleIdsAppGetToOneRelatedRequest) (*AppResponse, *http.Response, error) {
	var (
...
func (r ApiBundleIdsBundleIdCapabilitiesGetToManyRelatedRequest) Execute() (*BundleIdCapabilitiesResponse, *http.Response, error) {
...
func (a *BundleIdsApiService) BundleIdsBundleIdCapabilitiesGetToManyRelatedExecute(r ApiBundleIdsBundleIdCapabilitiesGetToManyRelatedRequest) (*BundleIdCapabilitiesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiBundleIdsProfilesGetToManyRelatedRequest) Execute() (*ProfilesResponse, *http.Response, error) {
...
func (a *BundleIdsApiService) BundleIdsProfilesGetToManyRelatedExecute(r ApiBundleIdsProfilesGetToManyRelatedRequest) (*ProfilesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
