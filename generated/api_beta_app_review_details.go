...
func (r ApiBetaAppReviewDetailsAppGetToOneRelatedRequest) Execute() (*AppResponse, *http.Response, error) {
...
//
//	@return AppResponse
func (a *BetaAppReviewDetailsApiService) BetaAppReviewDetailsAppGetToOneRelatedExecute(r ApiBetaAppReviewDetailsAppGetToOneRelatedRequest) (*AppResponse, *http.Response, error) {
	var (
