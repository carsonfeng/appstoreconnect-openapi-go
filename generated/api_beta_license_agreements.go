...
func (r ApiBetaLicenseAgreementsAppGetToOneRelatedRequest) Execute() (*AppResponse, *http.Response, error) {
...
//
//	@return AppResponse
func (a *BetaLicenseAgreementsApiService) BetaLicenseAgreementsAppGetToOneRelatedExecute(r ApiBetaLicenseAgreementsAppGetToOneRelatedRequest) (*AppResponse, *http.Response, error) {
	var (
