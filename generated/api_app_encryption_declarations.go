...
func (r ApiAppEncryptionDeclarationsAppGetToOneRelatedRequest) Execute() (*AppResponse, *http.Response, error) {
...
//
//	@return AppResponse
func (a *AppEncryptionDeclarationsApiService) AppEncryptionDeclarationsAppGetToOneRelatedExecute(r ApiAppEncryptionDeclarationsAppGetToOneRelatedRequest) (*AppResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
